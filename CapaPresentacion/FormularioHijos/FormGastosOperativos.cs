...
{
    public partial class FormGastosOperativos : Form
    {
        public FormGastosOperativos()
        {
            InitializeComponent();
            ...
            Text = "GastosOperativos"; // Asignamos titulo a la Ventana o Nombre
            LblTitulo.Text = "Gastos Operativos";
